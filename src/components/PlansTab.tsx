  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8">
        <Card className="relative p-8 space-y-6 bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all">
          <div className="space-y-2">
            <h3 className="text-2xl font-bold">{t.subscription.freePlan}</h3>
        ...
        <Card className="relative p-8 space-y-6 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 backdrop-blur-sm border-primary/50 hover:border-primary transition-all shadow-lg shadow-primary/10">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Crown className="text-accent" size={28} weight="fill" />
              <h3 className="text-2xl font-bold">{t.subscription.premiumPlan}</h3>
            </div>
            <div className="flex items-baseline gap-2">
