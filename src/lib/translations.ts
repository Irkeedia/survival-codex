...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    subscription: {
      ...
      limitedDownloads: 'No offline downloads',
      limitedAI: '25 AI requests / month',
    ...
    categories: {
      ...
      'first-aid': 'First Aid',
      signaling: 'Signaling',
      'santé_urgence': 'Emergency Health',
      'santé_soins': 'Health Care',
      'santé_chirurgie': 'Surgery',
      'nucléaire_protection': 'Nuclear Protection',
      'nucléaire_décontamination': 'Decontamination',
      'ingénierie_lowtech': 'Low-tech Engineering',
      'défense_tactique': 'Tactical Defense',
    },
    difficulty: {
      beginner: 'Beginner',
  ...
  fr: {
    ...
    subscription: {
      ...
      limitedDownloads: 'Pas de téléchargement hors ligne',
      limitedAI: '25 requêtes IA / mois',
  ...
  es: {
    ...
    subscription: {
      ...
      limitedDownloads: 'Sin descargas sin conexión',
      limitedAI: '25 solicitudes de IA / mes',
    ...
    categories: {
      ...
      'santé_urgence': 'Salud Urgente',
      'santé_soins': 'Cuidados de Salud',
      'santé_chirurgie': 'Cirugía',
      'nucléaire_protection': 'Protección Nuclear',
      'nucléaire_décontamination': 'Descontaminación',
      'ingénierie_lowtech': 'Ingeniería Low-tech',
      'défense_tactique': 'Defensa Táctica',
    },
    difficulty: {
  ...
  de: {
    ...
    subscription: {
      ...
      limitedDownloads: 'Keine Offline-Downloads',
      limitedAI: '25 KI-Anfragen / Monat',
    ...
    categories: {
      ...
      'santé_urgence': 'Notfallmedizin',
      'santé_soins': 'Gesundheitsversorgung',
      'santé_chirurgie': 'Chirurgie',
      'nucléaire_protection': 'Nuklearschutz',
      'nucléaire_décontamination': 'Dekontamination',
      'ingénierie_lowtech': 'Low-Tech-Ingenieurwesen',
      'défense_tactique': 'Taktische Verteidigung',
    },
    difficulty: {
      beginner: 'Anfänger',
  ...
  it: {
    ...
    subscription: {
      ...
      limitedDownloads: 'Nessun download offline',
      limitedAI: '25 richieste IA / mese',
    ...
    categories: {
      ...
      'santé_urgence': 'Salute Urgente',
      'santé_soins': 'Cure Sanitarie',
      'santé_chirurgie': 'Chirurgia',
      'nucléaire_protection': 'Protezione Nucleare',
      'nucléaire_décontamination': 'Decontaminazione',
      'ingénierie_lowtech': 'Ingegneria Low-tech',
      'défense_tactique': 'Difesa Tattica',
    },
    difficulty: {
      beginner: 'Principiante',
      intermediate: 'Intermedio',
